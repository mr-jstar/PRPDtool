...
public class ZipONNXClassifier implements AutoCloseable, Classifier {
    ...
    public ZipONNXClassifier(String modelPath, Preprocessor preprocessor, OutputParser parser) {
